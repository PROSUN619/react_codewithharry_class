...
export class News extends Component {
  ...
  async componentDidMount() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?category=${this.props.category}&country=in&apiKey=6dcdadbc546a431c83ff219a0e73afb8&page=1&pageSize=${this.props.pageSize}`;
  ...
  handlePreviousClick = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?category=${this.props.category}&country=in&apiKey=6dcdadbc546a431c83ff219a0e73afb8&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
    let data = await fetch(url);
    let parsedData = await data.json();
    console.log(parsedData);
    this.setState({
  ...
  render() {
    ...
    return (
      <div className="container">
        <h2 className="text-center">News Monkey - Top Headline</h2>
